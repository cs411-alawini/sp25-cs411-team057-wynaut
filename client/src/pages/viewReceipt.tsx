...
const ViewReceipt = ({
    ...
    async function getOldReceipt() {
        ...
        let test_data: Array<Receipt> = [
            { ReceiptID: 1, PurchaseDate: "Date", Seller: "Seller" },
            { ReceiptID: 2, PurchaseDate: "Date", Seller: "Seller" },
            { ReceiptID: 3, PurchaseDate: "Date", Seller: "Seller" },
            { ReceiptID: 4, PurchaseDate: "Date", Seller: "Seller" },
            { ReceiptID: 5, PurchaseDate: "Date", Seller: "Seller" },
            { ReceiptID: 6, PurchaseDate: "Date", Seller: "Seller" },
            { ReceiptID: 7, PurchaseDate: "Date", Seller: "Seller" },
        ];
        let curr_Receipts = [...oldReceipts];
        curr_Receipts.splice(0);
